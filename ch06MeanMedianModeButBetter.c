...
// The difference between the original code is that I made the solution slightly more difficult
// by making the set of numbers even.  This requires an extra maths step.
